...
// in flutter_mobx_shopping_list_app/test/data/repositories/create_repository_test.dart.
...
/// A class which mocks [CreateRemoteDataSource].
///
/// See the documentation for Mockito's code generation for more information.
class MockCreateRemoteDataSource extends _i1.Mock
    implements _i4.CreateRemoteDataSource {
  @override
  _i3.Future<void> createShoppingItem(_i5.ShoppingItemModel? item) =>
      (super.noSuchMethod(
        Invocation.method(
          #createShoppingItem,
          [item],
